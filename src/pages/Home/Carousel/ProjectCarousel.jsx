...
export default function ProjectCarousel() {
  return (
    <>
    <Swiper 
    className="max-w-6xl !flex flex-row  justify-between items-center gap-10"
            ...
            <SwiperSlide key={index}>
               ...
               <ContentLayout  title={project.title} element={(<Tag text={project.tag}/>)}  classTitle="section-white section-home-carousel"  subtitle={project.desc} btn_text="View Case Study" btnDecor="border-[1px] bg-transparent text-black hover:bg-linear-to-r hover:from-[#BC01FF] hover:to-[#46178f] hover:text-white  hover:border-0"/>
                ...
                <div className=' m-auto max-md:w-full'>
                    <img src={project.image} alt="" className='max-w-[480px] max-desktop-s3:max-w-[450px] max-desktop-s2:max-w-[370px] h-96 max-desktop-s2:h-80  max-md:max-w-full max-md:w-full rounded-3xl hover:opacity-80'/>
                </div>
                </div>
            </SwiperSlide>
        )
